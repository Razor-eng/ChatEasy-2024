                                    ...
                                    <FormControl>
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent className='w-full'>
                                                {unselectedFriends.map((friend, id) => (
                                    ...
                                    .map((friend, id) => (
                                        <div className="flex flex-col items-center gap-1" key={id}>
                                            <div className="relative">
                                                ...
                                                <X className='text-muted-foreground size-4 absolute bottom-8 left-7 bg-muted rounded-full cursor-pointer' onClick={() => form.setValue("members", members.filter((id) => id !== friend._id))} />
                                            </div>
                                            <p className="truncate text-sm font-[600]">{friend.username.split(" ")[0]}</p>
                                        </div>
                                    ))
                                }
                            </Card>
